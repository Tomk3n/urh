...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        self.spinBoxCenterOffset2 = QtWidgets.QDoubleSpinBox(SignalFrame)
        self.spinBoxCenterOffset2.setDecimals(4)
        self.spinBoxCenterOffset2.setObjectName("spinBoxCenterOffset2")
        self.gridLayout_2.addWidget(self.spinBoxCenterOffset2, 4, 1, 1, 1)
