...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        self.gridLayout_2.addWidget(self.chkBoxSyncSelection, 23, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sliderSpectrogramMin, 20, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chkBoxShowProtocol, 22, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelFFTWindowSize, 19, 0, 1, 1)
        ...
        self.cbProtoView.addItem("")
        self.cbProtoView.addItem("")
        self.gridLayout_2.addWidget(self.cbProtoView, 22, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lInfoLenText, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinBoxInfoLen, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lSignalViewText, 16, 0, 1, 1)
        self.line = QtWidgets.QFrame(SignalFrame)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout_2.addWidget(self.line, 14, 0, 1, 2)
        ...
        self.spinBoxCenter2Offset = QtWidgets.QDoubleSpinBox(SignalFrame)
        self.spinBoxCenter2Offset.setMinimumSize(QtCore.QSize(100, 0))
        self.spinBoxCenter2Offset.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.spinBoxCenter2Offset.setDecimals(4)
        self.spinBoxCenter2Offset.setMinimum(-3.15)
        self.spinBoxCenter2Offset.setMaximum(6.28)
        self.spinBoxCenter2Offset.setSingleStep(0.0001)
        self.spinBoxCenter2Offset.setObjectName("spinBoxCenter2Offset")
        self.gridLayout_2.addWidget(self.spinBoxCenter2Offset, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btnAutoDetect, 12, 0, 1, 2)
        ...
        self.cbSignalView.addItem("")
        self.cbSignalView.addItem("")
        self.gridLayout_2.addWidget(self.cbSignalView, 16, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sliderFFTWindowSize, 19, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sliderSpectrogramMax, 21, 1, 1, 1)
        self.labelSpectrogramMin = QtWidgets.QLabel(SignalFrame)
        self.labelSpectrogramMin.setObjectName("labelSpectrogramMin")
        self.gridLayout_2.addWidget(self.labelSpectrogramMin, 20, 0, 1, 1)
        self.labelSpectrogramMax = QtWidgets.QLabel(SignalFrame)
        self.labelSpectrogramMax.setObjectName("labelSpectrogramMax")
        self.gridLayout_2.addWidget(self.labelSpectrogramMax, 21, 0, 1, 1)
        self.lCenterOffset2 = QtWidgets.QLabel(SignalFrame)
        self.lCenterOffset2.setObjectName("lCenterOffset2")
        self.gridLayout_2.addWidget(self.lCenterOffset2, 4, 0, 1, 1)
...
"}")
        ...
        self.frequencyWidget = QtWidgets.QWidget(self.layoutWidget)
        self.frequencyWidget.setObjectName("frequencyWidget")
        self.verticalLayoutFrequency = QtWidgets.QVBoxLayout(self.frequencyWidget)
        self.verticalLayoutFrequency.setObjectName("verticalLayoutFrequency")
        self.stackedWidget = QtWidgets.QStackedWidget(self.frequencyWidget)
        ...
        self.verticalLayoutFrequency.addWidget(self.stackedWidget)
        self.stackedWidget_2 = QtWidgets.QStackedWidget(self.frequencyWidget)
        self.stackedWidget_2.setLineWidth(0)
        self.stackedWidget_2.setObjectName("stackedWidget_2")
        self.pageSignal_2 = QtWidgets.QWidget()
        self.pageSignal_2.setObjectName("pageSignal_2")
        self.horizontalLayout_6_2 = QtWidgets.QHBoxLayout(self.pageSignal_2)
        self.horizontalLayout_6_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_6_2.setSpacing(0)
        self.horizontalLayout_6_2.setObjectName("horizontalLayout_6_2")
        self.gvLegend_2 = LegendGraphicView(self.pageSignal_2)
        self.gvLegend_2.setMinimumSize(QtCore.QSize(0, 150))
        self.gvLegend_2.setMaximumSize(QtCore.QSize(30, 16777215))
        self.gvLegend_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.gvLegend_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.gvLegend_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.gvLegend_2.setInteractive(False)
        self.gvLegend_2.setResizeAnchor(QtWidgets.QGraphicsView.AnchorViewCenter)
        self.gvLegend_2.setRubberBandSelectionMode(QtCore.Qt.ContainsItemShape)
        self.gvLegend_2.setOptimizationFlags(QtWidgets.QGraphicsView.DontSavePainterState)
        self.gvLegend_2.setObjectName("gvLegend_2")
        self.horizontalLayout_6_2.addWidget(self.gvLegend_2)
        self.gvSignal_2 = EpicGraphicView(self.pageSignal_2)
        self.gvSignal_2.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gvSignal_2.sizePolicy().hasHeightForWidth())
        self.gvSignal_2.setSizePolicy(sizePolicy)
        self.gvSignal_2.setMinimumSize(QtCore.QSize(0, 150))
        self.gvSignal_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.gvSignal_2.setMouseTracking(True)
        self.gvSignal_2.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.gvSignal_2.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.gvSignal_2.setAutoFillBackground(False)
        self.gvSignal_2.setStyleSheet("")
        self.gvSignal_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.gvSignal_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.gvSignal_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.gvSignal_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.gvSignal_2.setInteractive(False)
        self.gvSignal_2.setRenderHints(QtGui.QPainter.Antialiasing|QtGui.QPainter.TextAntialiasing)
        self.gvSignal_2.setDragMode(QtWidgets.QGraphicsView.NoDrag)
        self.gvSignal_2.setCacheMode(QtWidgets.QGraphicsView.CacheNone)
        self.gvSignal_2.setTransformationAnchor(QtWidgets.QGraphicsView.NoAnchor)
        self.gvSignal_2.setResizeAnchor(QtWidgets.QGraphicsView.NoAnchor)
        self.gvSignal_2.setViewportUpdateMode(QtWidgets.QGraphicsView.MinimalViewportUpdate)
        self.gvSignal_2.setRubberBandSelectionMode(QtCore.Qt.ContainsItemShape)
        self.gvSignal_2.setOptimizationFlags(QtWidgets.QGraphicsView.DontClipPainter|QtWidgets.QGraphicsView.DontSavePainterState)
        self.gvSignal_2.setObjectName("gvSignal_2")
        self.horizontalLayout_6_2.addWidget(self.gvSignal_2)
        self.stackedWidget_2.addWidget(self.pageSignal_2)
        self.pageSpectrogram2 = QtWidgets.QWidget()
        self.pageSpectrogram2.setObjectName("pageSpectrogram2")
        self.horizontalLayout_4_2 = QtWidgets.QHBoxLayout(self.pageSpectrogram2)
        self.horizontalLayout_4_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4_2.setSpacing(0)
        self.horizontalLayout_4_2.setObjectName("horizontalLayout_4_2")
        self.gvSpectrogram2 = SpectrogramGraphicView(self.pageSpectrogram2)
        self.gvSpectrogram2.setMouseTracking(True)
        self.gvSpectrogram2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.gvSpectrogram2.setInteractive(False)
        self.gvSpectrogram2.setRenderHints(QtGui.QPainter.TextAntialiasing)
        self.gvSpectrogram2.setCacheMode(QtWidgets.QGraphicsView.CacheNone)
        self.gvSpectrogram2.setTransformationAnchor(QtWidgets.QGraphicsView.NoAnchor)
        self.gvSpectrogram2.setViewportUpdateMode(QtWidgets.QGraphicsView.MinimalViewportUpdate)
        self.gvSpectrogram2.setOptimizationFlags(QtWidgets.QGraphicsView.DontClipPainter|QtWidgets.QGraphicsView.DontSavePainterState)
        self.gvSpectrogram2.setObjectName("gvSpectrogram2")
        self.horizontalLayout_4_2.addWidget(self.gvSpectrogram2)
        self.stackedWidget_2.addWidget(self.pageSpectrogram2)
        self.verticalLayoutFrequency.addWidget(self.stackedWidget_2)
        self.horizontalLayout_2.addWidget(self.frequencyWidget)
        ...
        SignalFrame.setTabOrder(self.spinBoxCenterOffset, self.spinBoxCenter2Offset)
        SignalFrame.setTabOrder(self.spinBoxCenter2Offset, self.spinBoxInfoLen)
    ...
    def retranslateUi(self, SignalFrame):
        ...
        self.cbModulationType.setItemText(3, _translate("SignalFrame", "QAM"))
        self.cbModulationType.setItemText(4, _translate("SignalFrame", "OQPSK"))
...
"If you want your protocol to be better seperated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView."))
        ...
        self.lCenterOffset2.setText(_translate("SignalFrame", "Center 2:"))
